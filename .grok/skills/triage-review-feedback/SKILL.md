...
4. Tag every FIX NEW or REPEAT; REPEAT closes only with a mechanical check (lint/diagnostic/test/CI rule), never an instance fix or a comment — worked example: fixtures/repeat-exporter-dropped-references/.
