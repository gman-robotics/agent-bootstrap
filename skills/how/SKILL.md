...
- `model`: your configured how-explorer model (default Haiku-tier model (see skills/subagent-routing/SKILL.md))
...
- `subagent_type`: per `skills/subagent-routing/SKILL.md`
- `model`: your configured how-explainer model (default Sonnet-tier model (see skills/subagent-routing/SKILL.md))
- read-only subagent mode when the harness supports it
