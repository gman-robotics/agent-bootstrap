...
- Branch: `cursor/bootstrap-leftover-gates-6517` (unchanged). PR updated in place — [#12](https://github.com/gman-robotics/agent-bootstrap/pull/12). No second PR opened. Not merged.
